...
mosaicplot(table_contingence_duree_douleur_S, main = "Mosaïque Douleur x Duree Stress", cex.axis = 0.8, col = terrain.colors(length(unique(dataS$Douleur_Stress_NM))), las=4, xlab="")
