...
mosaicplot(table_contingence_duree_evol_TH[c(4, 2, 3, 1, 5),c(1, 4, 6, 7, 5, 3, 2)], main = "Mosaïque Evolution x Duree TH", cex.axis = 0.8, col = terrain.colors(length(unique(data1$Evolution_TH))),las = 4)
