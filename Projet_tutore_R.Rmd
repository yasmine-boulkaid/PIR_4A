...
QuestionsDuree <- function(data, liste){
  for (col in liste){
    data[[col]][data[[col]] == ""] <- "0"
    data[[col]] <- factor(data[[col]], levels = c("0","Moins de 3 mois", "Entre 3 et 6 mois", "Entre 6 mois et 2 ans", "Entre 2 et 5 ans", "Plus de 5 ans"), ordered = FALSE)
  }
  return(data)
}
...
QuestionsFrequence <- function(data, liste){
  for (col in liste) {
    data[[col]][data[[col]] == ""] <- "0"
    data[[col]] <- factor(data[[col]], levels = c("0","Plusieurs fois par jour", "Plusieurs fois par semaine", "Plusieurs fois par mois", "Plusieurs fois par an", "Moins d'une fois par an"), ordered = TRUE)
  }
  return(data)
}
...
QuestionsDouleur <- function(data, liste){
  for (col in liste) {
    data[[col]][data[[col]] == ""] <- "0"
    data[[col]] <- factor(data[[col]], levels = c("0", "Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = FALSE)
  }
  return(data)
}
...
QuestionsDouleur2 <- function(data, liste){
  for (col in liste) {
    data[[col]][data[[col]] == ""] <- "0"
    data[[col]] <- factor(data[[col]], levels = c("0", "Augmentation de la douleur", "Pas d'impact sur la douleur", "Diminution de la douleur"), ordered = FALSE)
  }
  return(data)
}
...
QuestionsEvolution <- function(data, liste){
  for (col in liste) {
    data[[col]][data[[col]] == ""] <- "0"
    data[[col]] <- factor(data[[col]], levels = c("0", "Apparition de nouvelles lésions", "Grossissement des lésions déjà présentes", "Pas d'évolution", "Réduction modérée des lésions", "Réduction importante voire disparition des lésions", "Ne sais pas"), ordered = FALSE)
  }
  return(data)
}
...
QuestionsEvolution2 <- function(data, liste){
  for (col in liste) {
    data[[col]][data[[col]] == ""] <- "0"
    data[[col]] <- factor(data[[col]], levels = c("0", "Augmentations des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = FALSE)
  }
  return(data)
}
...
data1 <- data[which(data$TH == "yes"), 11:94]

#Second data frame

data2 <- data[which(data$CM == "yes"), 95:178]

#Troisième data frame

data3 <- data[which(data$Aucun_NM == "no"), 179:314]
```
...
labels <- c("Under 25 years old",  "26-30 years old", "31-35 years old", "36-40 years old", "Over 40 years old")
...
ggplot(df_age_counts, aes(x = Tranches_age, y = count)) +
  geom_bar(stat = "identity", fill = "skyblue") +
  labs(title = "Age Distribution (Survey)", x = "Age Groups", y = "Number of Occurrences")

# Histogramme pour df_age_counts_bis_filtre
ggplot(df_age_counts_bis_filtre, aes(x = Tranches_age, y = count)) +
  geom_bar(stat = "identity", fill = "lightgreen") +
  labs(title = "Age Distribution (French female population)", x = "Age Groups", y = "Number of Occurrences")
...
couleurs <- c("Augmentation de la douleur" = "#FF6347", # "#EEB99F" "#EAB64E"
              "Pas d'impact sur la douleur" = "#E6E600", 
              "Réduction légère de la douleur" = "#63C600",
              "Réduction importante de la douleur" = "#00A600") 
...
mosaicplot(table_contingence_duree_douleur_TH, main = "Mosaïque Douleur x Duree TH", cex.axis = 0.8, las=4, color = couleurs, xlab = "") # , col = terrain.colors(length(unique(data1$Douleur_TH)))
...
mosaicplot(table_contingence_duree_douleur_CM, main = "Mosaïque Douleur x Duree CM", cex.axis = 0.8, color = couleurs, las=4, xlab = "")
...
mosaicplot(table_contingence_duree_douleur_M, main = "Mosaïque Douleur x Duree Mobilite", cex.axis = 0.8, color = couleurs, las=4, xlab = "")
...
mosaicplot(table_contingence_duree_douleur_N, main = "Mosaïque Douleur x Duree Nutrition", cex.axis = 0.8, color = couleurs, las=4, xlab="")
...
Douleur_S <- factor(dataS$Douleur_Stress_NM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), labels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
mosaicplot(table_contingence_duree_douleur_S, main = "Mosaïque Douleur x Duree Stress", cex.axis = 0.8, color = couleurs, las=4, xlab="", ylab="")
...
Duree_P <- factor(ifelse(dataP$Depuis_Phyto == "0", as.character(dataP$Combien_Phyto_NM), as.character(dataP$Depuis_Phyto_NM)), levels = c("Moins de 3 mois", "Entre 3 et 6 mois", "Entre 6 mois et 2 ans", "Entre 2 et 5 ans", "Plus de 5 ans"), labels = c(".          - 3 months", "3 months /\n6 months  ", "6 months /\n2 years  ", "2 years /\n5 years  ", ".          + 5 years"), ordered = TRUE)
...
mosaicplot(table_contingence_duree_douleur_P, main = "Mosaïc Pain x Duration for Herbal medicine", cex.axis = 0.8, color = couleurs, las=4, xlab="")
...
mosaicplot(table_contingence_duree_douleur_A, main = "Mosaïque Douleur x Duree Acupuncture", cex.axis = 0.8, color = couleurs, las=4, xlab="")
...
Douleur_H <- factor(dataH$Douleur_Hypnose_NM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), labels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
mosaicplot(table_contingence_duree_douleur_H, main = "Mosaïque Douleur x Duree Hypnose", cex.axis = 0.8, color = couleurs, las=4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_douleur_B, main = "Mosaïque Douleur x Duree Bouillotte", cex.axis = 0.8, color = couleurs, las=4, xlab="")
...
mosaicplot(table_contingence_duree_douleur_C, main = "Mosaïque Douleur x Duree CBD", cex.axis = 0.8, color = couleurs, las=4, xlab="")
...
mosaicplot(table_contingence_duree_douleur_T, main = "Mosaïque Douleur x Duree TENS", cex.axis = 0.8, color = couleurs, las=4, xlab="")
...
couleurs2 <- c("Apparition de nouvelles lésions" = "#FF6347", # "#EEB99F" "#EAB64E"
              "Grossissement des lésions déjà présentes" = "#EAB64E", 
              "Pas d'évolution" = "#E6E600",
              "Réduction modérée des lésions" = "#63C600",
              "Réduction importante voire disparition des lésions" = "#00A600") 
...
mosaicplot(table_contingence_duree_evol_TH[,1:5], main = "Mosaïque Evolution x Duree TH", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_CM[,1:5], main = "Mosaïque Evolution x Duree CM", cex.axis = 0.8, color = couleurs2,las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Mobilite[,1:5], main = "Mosaïque Evolution x Duree Mobilite", cex.axis = 0.8, color = couleurs2,las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Nutrition[,1:5], main = "Mosaïque Evolution x Duree Nutrition", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Stress[,1:5], main = "Mosaïque Evolution x Duree Stress", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Phyto[,1:5], main = "Mosaïque Evolution x Duree Phyto", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Acup[,1:5], main = "Mosaïque Evolution x Duree Acup", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Hypnose[,1:5], main = "Mosaïque Evolution x Duree Hypnose", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Bouillotte[,1:5], main = "Mosaïque Evolution x Duree Bouillotte", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_duree_evol_Tens[,1:5], main = "Mosaïque Evolution x Duree Tens", cex.axis = 0.8, color = couleurs2, las = 4, xlab="", ylab="")
...
mosaicplot(table_contingence_prise_douleur_TH, main = "Mosaïque Douleur x Prise TH", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_CM, main = "Mosaïque Douleur x Prise CM", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Mobilite, main = "Mosaïque Douleur x Prise Mobilite", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Nutrition, main = "Mosaïque Douleur x Prise Nutrition", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Stress, main = "Mosaïque Douleur x Prise Stress", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Phyto, main = "Mosaïque Douleur x Prise Phyto", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Acup, main = "Mosaïque Douleur x Prise Acup", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Hypnose, main = "Mosaïque Douleur x Prise Hypnose", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Bouillotte, main = "Mosaïque Douleur x Prise Bouillotte", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_CBD, main = "Mosaïque Douleur x Prise CBD", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
mosaicplot(table_contingence_prise_douleur_Tens, main = "Mosaïque Douleur x Prise Tens", cex.axis = 0.7, color = couleurs, las=1, xlab="")
...
couleurs3 <- c("Oui" = "#FF6347", # "#EEB99F" "#EAB64E"
              "Non" = "#00A600")
...
mosaicplot(table_contingence_duree_ES_TH, main = "Graphique de Mosaïque", cex.axis = 0.8, color = couleurs3, las = 4, xlab="")
...
mosaicplot(table_contingence_duree_ES_CM, main = "Graphique de Mosaïque", cex.axis = 0.8, color = couleurs3, las = 4, xlab="")
...
couleurs4 <- c("Augmentation de la douleur" = "#FBB4AE",
              "Pas d'impact sur la douleur" = "#FFF2AE", 
              "Réduction légère de la douleur" = "#CCEBC5",
              "Réduction importante de la douleur" = "#B3E2CD")
...
# Légendes en anglais
new_legend_names <- c("Increase in pain", "No impact on pain", "Slight reduction in pain", "Significant reduction in pain")

# Remplacer les légendes dans les tableaux de données
names(data1_table) <- new_legend_names

pie(data1_table, main = "Perception of pain under Hormonal Treatment", labels = percentage_labels1, col = couleurs4, cex.main = 0.75) # col = colors_pastels_data1
legend("bottom", legend = names(data1_table), fill = couleurs4, title = "Pain scale", cex = 0.75, xpd = TRUE, inset = c(0, -0.3))
...
names(data2_table) <- new_legend_names

pie(data2_table, main = "Perception of pain under Artificial Menopause", labels = percentage_labels2, col = couleurs4, cex.main = 0.75)
legend("bottom", legend = names(data2_table), fill = couleurs4, title = "Pain scale", cex = 0.75, xpd = TRUE, inset = c(0, -0.3))
...
couleurs5 <- c("Apparition de nouvelles lésions" = "#FBB4AE",
              "Grossissement des lésions déjà présentes" = "#FED9A6",
              "Pas d'évolution" = "#FFF2AE",
              "Réduction modérée des lésions" = "#CCEBC5",
              "Réduction importante voire disparition des lésions" = "#B3E2CD",
              "Ne sais pas" = "#FDDAEC")
...
# Légendes en anglais
new_legend_names2 <- c("Appearance of new lesions", "Enlargement of pre-existing lesions", "No evolution", "Moderate reduction of lesions", "Significant reduction or disappearance of lesions", "Don't know")

# Remplacer les légendes dans les tableaux de données
names(data1_table) <- new_legend_names2

pie(data1_table, main = "Disease Evolution under Hormonal Treatment", labels = percentage_labels1, col = couleurs5, cex.main = 0.75)
legend("bottom", legend = names(data1_table), fill = couleurs5, title = "Evolution scale", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
names(data2_table) <- new_legend_names2

pie(data2_table, main = "Disease Evolution under Artificial Menopause", labels = percentage_labels2, col = couleurs5, cex.main = 0.75)
legend("bottom", legend = names(data2_table), fill = couleurs5, title = "Evolution scale", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
couleurs6 <- c("Augmentation de la douleur" = "#FBB4AE",
              "Pas d'impact sur la douleur" = "#FFF2AE", 
              "Diminution de la douleur" = "#CCEBC5")
...
pie(data1_MTH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Mobilite", labels = percentage_labels_MTH, col = couleurs6)
legend("bottom", legend = names(data1_MTH_table), fill = couleurs6, title = "Douleur TH x Mobilite", cex = 0.9)
...
pie(data1_NTH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Nutrition", labels = percentage_labels_NTH, col = couleurs6)
legend("bottom", legend = names(data1_NTH_table), fill = couleurs6, title = "Douleur TH x Nutrition", cex = 0.9)
...
pie(data1_STH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Stress", labels = percentage_labels_STH, col = couleurs6)
legend("bottom", legend = names(data1_STH_table), fill = couleurs6, title = "Douleur TH x Stress", cex = 0.9)
...
couleurs7 <- c("Pas d'impact sur la douleur" = "#FFF2AE")
...
pie(data1_PTH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Phyto", labels = percentage_labels_PTH, col = couleurs7)
legend("bottom", legend = names(data1_PTH_table), fill = couleurs7, title = "Douleur TH x Phyto", cex = 0.9)
...
couleurs8 <- c("Pas d'impact sur la douleur" = "#FFF2AE", 
              "Diminution de la douleur" = "#CCEBC5")
...
pie(data1_ATH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Acup", labels = percentage_labels_ATH, col = couleurs8)
legend("bottom", legend = names(data1_ATH_table), fill = couleurs8, title = "Douleur TH x Acup", cex = 0.9)
...
pie(data1_HTH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Hypnose", labels = percentage_labels_HTH, col = couleurs8)
legend("bottom", legend = names(data1_HTH_table), fill = couleurs8, title = "Douleur TH x Hypnose", cex = 0.9)
...
pie(data1_BTH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Bouillotte", labels = percentage_labels_BTH, col = couleurs8)
legend("bottom", legend = names(data1_BTH_table), fill = couleurs8, title = "Douleur TH x Bouillotte", cex = 0.9)
...
pie(data1_CTH_table, main = "Échelles de douleur sous\nTraitement Hormonal x CBD", labels = percentage_labels_CTH, col = couleurs6)
legend("bottom", legend = names(data1_CTH_table), fill = couleurs6, title = "Douleur TH x CBD", cex = 0.9)
...
pie(data1_TTH_table, main = "Échelles de douleur sous\nTraitement Hormonal x Tens", labels = percentage_labels_TTH, col = couleurs6)
legend("bottom", legend = names(data1_TTH_table), fill = couleurs6, title = "Douleur TH x Tens", cex = 0.9)
...
noms_variables_en <- c("Mobility", "Nutrition", "Stress", "Herbal\nmedicine", "Acup", "Hypnosis", "Hot Water\nbottle", "CBD", "TENS")
...
resultats1 <- data.frame(Variable = noms_variables_en, Pourcentage = pourcentages, Total = total1)
...
bp <- barplot(resultats1$Pourcentage, names.arg = resultats1$Variable,
        xlab = "Variable", ylab = "Percentage of 'pain reduction'",
        main = "Percentage of 'pain reduction' by variable for each\nnon-drug treatment associated with hormonal treatment",
...
noms_variables_en2 <- c("Mobility", "Nutrition", "Stress", "Herbal\nmedicine", "Acup", "Hot Water\nbottle", "CBD", "TENS")
...
# Créer un dataframe pour stocker les résultats
resultats2 <- data.frame(Variable = noms_variables_en2, Pourcentage = pourcentages2, Total = total2)
...
bp <- barplot(resultats2$Pourcentage, names.arg = resultats2$Variable,
              xlab = "Variable", ylab = "Percentage of 'pain reduction'",
              main = "Percentage of 'pain reduction' by variable for each\nnon-drug treatment associated with Artificial Menopause",
...
for (i in seq_along(noms_variables3)) {
  ...
  pourcentages3[i] <- (sum(filtered_data3[[variable3]] == "Réduction légère de la douleur") + sum(filtered_data3[[variable3]] == "Réduction importante de la douleur") + sum(filtered_data3[[variable3]] == "Slight reduction in pain") + sum(filtered_data3[[variable3]] == "Significant reduction in pain")) / nrow(filtered_data3) * 100
}
...
# Créer un dataframe pour stocker les résultats
resultats3 <- data.frame(Variable = noms_variables_en, Pourcentage = pourcentages3, Total = total3)
...
bp <- barplot(resultats3$Pourcentage, names.arg = resultats3$Variable,
              xlab = "Variable", ylab = "Percentage of 'pain reduction'",
              main = "Percentage of 'pain reduction' by variable for each non-drug treatment\nwithout any association with drug treatment",
