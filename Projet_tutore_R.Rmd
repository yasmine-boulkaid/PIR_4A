...
table_contingence_duree_evol_TH <- table(Duree_TH, Evolution_TH)
...
mosaicplot(table_contingence_duree_evol_TH, main = "Mosaïque Evolution x Duree TH", cex.axis = 0.8, col = terrain.colors(length(unique(data1$Evolution_TH))),las = 4, xlab="", ylab="")
...
table_contingence_duree_evol_CM <- table(Duree_CM, Evolution_CM)
...
mosaicplot(table_contingence_duree_evol_CM, main = "Mosaïque Evolution x Duree CM", cex.axis = 0.8, col = terrain.colors(length(unique(data2$Evolution_CM))),las = 4, xlab="", ylab="")


#Evolution de la maladie en fonction de la duree de prise du traitement Mobilite (qu'il y ait eu arrêt ou non)

table_contingence_duree_evol_Mobilite <- table(Duree_M, dataM$Evolution_Mobilite_NM[dataM$Evolution_Mobilite_NM != "0"])
...
mosaicplot(table_contingence_duree_evol_Mobilite, main = "Mosaïque Evolution x Duree Mobilite", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Mobilite_NM))),las = 4, xlab="")
...
>>>>>>> 0a95afaf2a4146eed9f58722eaa9bb5c7aeaaef0
