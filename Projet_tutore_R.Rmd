...
# Test couleurs
```{r}
# Création de couleurs pastel dans les tons de rouge
couleurs_pastel_rouge <- c("#FFCCCC", "#FF9999", "#FFB6C1", "#FFA07A", "#FF6347")

terrain.colors(6)

"#00A600" "#63C600" "#E6E600" "#EAB64E" "#EEB99F" "#F2F2F2"
```
...
mosaicplot(table_contingence_duree_douleur_P, main = "Mosaïque Douleur x Duree Phyto", cex.axis = 0.8, color = couleurs, las=4, xlab="")
...
NE GARDER QUE LES 2 PREMIERS MOSAICPLOTS ?
...
pie(data1_table, main = "Échelles de douleur sous Traitement Hormonal", labels = percentage_labels1, col = couleurs4, cex.main = 0.75) # col = colors_pastels_data1
legend("bottom", legend = names(data1_table), fill = couleurs4, title = "Douleur_TH", cex = 0.75, xpd = TRUE, inset = c(0, -0.3))
...
pie(data2_table, main = "Échelles de douleur sous Cure de Ménopause", labels = percentage_labels2, col = couleurs4, cex.main = 0.75)
legend("bottom", legend = names(data2_table), fill = couleurs4, title = "Douleur_CM", cex = 0.75, xpd = TRUE, inset = c(0, -0.3))
...
pie(data1_table, main = "Échelles d'évolution sous Traitement Hormonal", labels = percentage_labels1, col = couleurs5, cex.main = 0.75)
legend("bottom", legend = names(data1_table), fill = couleurs5, title = "Evolution_TH", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
pie(data2_table, main = "Échelles d'évolution sous Cure de Ménopause", labels = percentage_labels2, col = couleurs5, cex.main = 0.75)
legend("bottom", legend = names(data2_table), fill = couleurs5, title = "Evolution_CM", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
# Barplot de diminution de la douleur par combos avec TH
```{r}
options(repr.plot.width = 15, repr.plot.height = 8)

# Créer un vecteur contenant les noms des variables Douleur_qqch_TH
noms_variables <- c("Mobilite", "Nutrition", "Stress", "Acup", "Hypnose", "Bouillotte", "CBD", "Tens")
...
total1 = c(sum(data1_MTH_table), sum(data1_NTH_table), sum(data1_STH_table), sum(data1_ATH_table), sum(data1_HTH_table), sum(data1_BTH_table), sum(data1_CTH_table), sum(data1_TTH_table))
...
```{r}
test = chisq.test(table_contingence_tabac_douleur_TH)
test$expected
```
