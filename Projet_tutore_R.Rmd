...
legend("bottom", legend = categoriesDNM, fill = colors_pastels_data_MNM, title = "Douleur NM x Mobilite")
...
legend("bottom", legend = categoriesDNM, fill = colors_pastels_data_NNM, title = "Douleur NM x Nutrition")
...
legend("bottom", legend = categoriesDNM, fill = colors_pastels_data_SNM, title = "Douleur NM x Stress")
...
# Créer un vecteur contenant les noms des variables Douleur_qqch_NM
noms_variables <- c("Mobilite", "Nutrition", "Stress", "Phyto", "Acup", "Hypnose", "Bouillotte", "CBD", "Tens")
...
# Calculer les pourcentages de "Diminution de la douleur" pour chaque variable
for (i in seq_along(noms_variables)) {
  variable <- paste0("Douleur_", noms_variables[i], "_NM")
  filtered_data <- data3[data3[[paste0(noms_variables[i], "_NM")]] == 1, ]
  pourcentages[i] <- sum(filtered_data[[variable]] == "Diminution de la douleur") / nrow(filtered_data) * 100
}
...
# Créer un dataframe pour stocker les résultats
resultats3 <- data.frame(Variable = noms_variables, Pourcentage = pourcentages, Total = total3)
...
bp <- barplot(resultats3$Pourcentage, names.arg = resultats3$Variable,
        xlab = "Variable", ylab = "Pourcentage de 'Diminution de la douleur' ",
        main = "Pourcentage de 'Diminution de la douleur' par variable pour chaque traitement non médicamenteux associé à NM",
        col = brewer.pal(length(noms_variables), "Pastel1"),
        ylim=c(0,100))
