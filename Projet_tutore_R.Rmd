...
data$Douleur_Phyto_NM <- factor(Douleur_Phyto_NM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), labels = c("Increase in pain", "No impact on pain",  "Slight reduction in pain", "Significant reduction in pain"), ordered = TRUE)
