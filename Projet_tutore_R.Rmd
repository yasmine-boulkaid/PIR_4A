...
data$Douleur_Mobilite_TH <- factor(Douleur_Mobilite_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)

Evolution_Mobilite_TH <- ifelse(data$Evolution_Mobilite_TH == "", "0", data$Evolution_Mobilite_TH)
data$Evolution_Mobilite_TH <- factor(Evolution_Mobilite_TH, levels = c("Apparition de nouvelles lésions", "Grossissement des lésions déjà présentes", "Pas d'évolution", "Réduction modérée des lésions", "Réduction importante voire disparition des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Douleur_Nutrition_TH <- factor(Douleur_Nutrition_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Stress_TH <- factor(Douleur_Stress_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Phyto_TH <- factor(Douleur_Phyto_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Acup_TH <- factor(Douleur_Acup_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Hypnose_TH <- factor(Douleur_Hypnose_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Bouillotte_TH <- factor(Douleur_Bouillotte_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_CBD_TH <- factor(Douleur_CBD_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Tens_TH <- factor(Douleur_Tens_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Mobilite_CM <- factor(Douleur_Mobilite_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Nutrition_CM <- factor(Douleur_Nutrition_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Stress_CM <- factor(Douleur_Stress_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Phyto_CM <- factor(Douleur_Phyto_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Acup_CM <- factor(Douleur_Acup_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Hypnose_CM <- factor(Douleur_Hypnose_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Bouillotte_CM <- factor(Douleur_Bouillotte_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_CBD_CM <- factor(Douleur_CBD_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
data$Douleur_Tens_CM <- factor(Douleur_Tens_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), ordered = TRUE)
...
## Tentative d'afficher les pyramides une sur l'autre
```{r}
...
## Regroupement en tranches d'âges
```{r}
...
## Test khi2 d'adéquation des âges
```{r}
...
RESTE À FAIRE : REFAIRE LE TEST EN FAISANT DES REGROUPEMENTS DES ÂGES
## Test khi2 d'adéquation des tranches d'âges 
```{r}
# Effectuer un test du khi-deux pour comparer les distributions d'âge

chisq.test(tranches_age, tranches_age_pyramide)
length(df_age_counts$age)
length(df_age_counts_bis$age[19:54])
?chisq.test
```
...
mosaicplot(table_contingence_duree_douleur_TH[c(4, 2, 3, 1, 5),c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Duree TH", cex.axis = 1, col = terrain.colors(length(unique(data1$Douleur_TH))),las=4)
...
mosaicplot(table_contingence_duree_douleur_CM[c(4, 2, 3, 1, 5),c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Duree CM", cex.axis = 1, col = terrain.colors(length(unique(data2$Douleur_CM))),las=4)
...
Duree_M <- factor(ifelse(dataM$Depuis_Mobilite == "0", as.character(dataM$Combien_Mobilite_NM), as.character(dataM$Depuis_Mobilite_NM)))

table_contingence_duree_douleur_M <- table(Duree_M, dataM$Douleur_Mobilite_NM[dataM$Douleur_Mobilite_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_M[c(4, 2, 3, 1, 5),c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Duree Mobilite", cex.axis = 1, col = terrain.colors(length(unique(dataM$Douleur_Mobilite_NM))),las=4)
...
Duree_N <- factor(ifelse(dataN$Depuis_Nutrition == "0", as.character(dataN$Combien_Nutrition_NM), as.character(dataN$Depuis_Nutrition_NM)))

table_contingence_duree_douleur_N <- table(Duree_N, dataN$Douleur_Nutrition_NM[dataN$Douleur_Nutrition_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_N[c(4, 2, 3, 1, 5),c(1, 3, 4, 2)], main = "Mosaïque Douleur x Duree Nutrition", cex.axis = 1, col = terrain.colors(length(unique(dataN$Douleur_Nutrition_NM))), las=4)
...
Duree_S <- factor(ifelse(dataS$Depuis_Stress == "0", as.character(dataS$Combien_Stress_NM), as.character(dataS$Depuis_Stress_NM)))

table_contingence_duree_douleur_S <- table(Duree_S, dataS$Douleur_Stress_NM[dataS$Douleur_Stress_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_S[c(4, 2, 3, 1, 5),c(1, 3, 4, 2)], main = "Mosaïque Douleur x Duree Stress", cex.axis = 1, col = terrain.colors(length(unique(dataS$Douleur_Stress_NM))), las=4)
...
Duree_P <- factor(ifelse(dataP$Depuis_Phyto == "0", as.character(dataP$Combien_Phyto_NM), as.character(dataP$Depuis_Phyto_NM)))

table_contingence_duree_douleur_P <- table(Duree_P, dataP$Douleur_Phyto_NM[dataP$Douleur_Phyto_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_P[c(4, 2, 3, 1, 5),c(1, 3, 4, 2)], main = "Mosaïque Douleur x Duree Phyto", cex.axis = 1, col = terrain.colors(length(unique(dataP$Douleur_Phyto_NM))), las=4)
...
Duree_A <- factor(ifelse(dataA$Depuis_Acup == "0", as.character(dataA$Combien_Acup_NM), as.character(dataA$Depuis_Acup_NM)))

table_contingence_duree_douleur_A <- table(Duree_A, dataA$Douleur_Acup_NM[dataA$Douleur_Acup_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_A[c(4, 2, 3, 1, 5),c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Duree Acupuncture", cex.axis = 1, col = terrain.colors(length(unique(dataA$Douleur_Acup_NM))), las=4)
...
Duree_H <- factor(ifelse(dataH$Depuis_Hypnose == "0", as.character(dataH$Combien_Hypnose_NM),as.character(dataH$Depuis_Hypnose_NM)))

table_contingence_duree_douleur_H <- table(Duree_H, dataH$Douleur_Hypnose_NM[dataH$Douleur_Hypnose_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_H[c(4, 2, 3, 1, 5),c(1, 3, 4, 2)], main = "Mosaïque Douleur x Duree Hypnose", cex.axis = 1, col = terrain.colors(length(unique(dataH$Douleur_Hypnose_NM))), las=4)
...
Duree_B <- factor(ifelse(dataB$Depuis_Bouillotte == "0", as.character(dataB$Combien_Bouillotte_NM), as.character(dataB$Depuis_Bouillotte_NM)))

table_contingence_duree_douleur_B <- table(Duree_B, dataB$Douleur_Bouillotte_NM[dataB$Douleur_Bouillotte_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_B[c(4, 2, 3, 1, 5),c(1, 3, 4, 2)], main = "Mosaïque Douleur x Duree Bouillotte", cex.axis = 1, col = terrain.colors(length(unique(dataB$Douleur_Bouillotte_NM))), las=4)
...
Duree_C <- factor(ifelse(dataC$Depuis_CBD == "0", as.character(dataC$Combien_CBD_NM), as.character(dataC$Depuis_CBD_NM)))

table_contingence_duree_douleur_C <- table(Duree_C, dataC$Douleur_CBD_NM[dataC$Douleur_CBD_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_C[c(4, 2, 3, 1, 5),c(1, 3, 4, 2)], main = "Mosaïque Douleur x Duree CBD", cex.axis = 1, col = terrain.colors(length(unique(dataC$Douleur_CBD_NM))), las=4)
...
Duree_T <- factor(ifelse(dataT$Depuis_Tens == "0", as.character(dataT$Combien_Tens_NM), as.character(dataT$Depuis_Tens_NM)))

table_contingence_duree_douleur_T <- table(Duree_T, dataT$Douleur_Tens_NM[dataT$Douleur_Tens_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_douleur_T[c(4, 2, 3, 1, 5),c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Duree TENS", cex.axis = 1, col = terrain.colors(length(unique(dataT$Douleur_Tens_NM))), las=4)
...
table_contingence_duree_evol_TH <- table(data1$Duree_TH, data1$Evolution_TH[data1$Evolution_TH != "0"])

table_contingence_duree_evol_TH <- table_contingence_duree_evol_TH[table_contingence_duree_evol_TH != 0]  # Filtrer les zéros

options(repr.plot.width = 12, repr.plot.height = 8)

#[c(4, 2, 3, 1, 5),c(1, 4, 6, 7, 5, 3, 2)]

mosaicplot(table_contingence_duree_evol_TH, main = "Mosaïque Evolution x Duree TH", cex.axis = 0.8, col = terrain.colors(length(unique(data1$Evolution_TH))),las = 4)
...
mosaicplot(table_contingence_duree_evol_CM[c(4, 2, 3, 1, 5),c(1, 4, 6, 7, 5, 3, 2)], main = "Mosaïque Evolution x Duree CM", cex.axis = 0.8, col = terrain.colors(length(unique(data2$Evolution_CM))),las = 4)


#Evolution de la maladie en fonction de la duree de prise du traitement Mobilite (qu'il y ait eu arrêt ou non)

table_contingence_duree_evol_Mobilite <- table(Duree_M, data3$Evolution_Mobilite_NM[data$Evolution_Mobilite_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Mobilite[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Mobilite", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Mobilite_NM))),las = 4)

# Evolution de la maladie en fonction de la duree de prise du traitement Nutrition (qu'il y ait eu arrêt ou non)
table_contingence_duree_evol_Nutrition <- table(Duree_N, data3$Evolution_Nutrition_NM[data3$Evolution_Nutrition_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Nutrition[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Nutrition", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Nutrition_NM))),las = 4)

# Evolution de la maladie en fonction de la duree de prise du traitement Stress (qu'il y ait eu arrêt ou non)
table_contingence_duree_evol_Stress <- table(Duree_S, data3$Evolution_Stress_NM[data3$Evolution_Stress_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Stress[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Stress", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Stress_NM))),las = 4)

# Evolution de la maladie en fonction de la duree de prise du traitement Phyto (qu'il y ait eu arrêt ou non)
table_contingence_duree_evol_Phyto <- table(Duree_P, data3$Evolution_Phyto_NM[data3$Evolution_Phyto_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Phyto[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Phyto", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Phyto_NM))),las = 4)

# Evolution de la maladie en fonction de la duree de prise du traitement Acup (qu'il y ait eu arrêt ou non)
table_contingence_duree_evol_Acup <- table(Duree_A, data3$Evolution_Acup_NM[data3$Evolution_Acup_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Acup[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Acup", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Acup_NM))),las = 4)

# Evolution de la maladie en fonction de la duree de prise du traitement Hypnose (qu'il y ait eu arrêt ou non)
table_contingence_duree_evol_Hypnose <- table(Duree_H, data3$Evolution_Hypnose_NM[data3$Evolution_Hypnose_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Hypnose[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Hypnose", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Hypnose_NM))),las = 4)

# Evolution de la maladie en fonction de la duree de prise du traitement Bouillotte (qu'il y ait eu arrêt ou non)
table_contingence_duree_evol_Bouillotte <- table(Duree_B, data3$Evolution_Bouillotte_NM[data3$Evolution_Bouillotte_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Bouillotte[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Bouillotte", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Bouillotte_NM))),las = 4)

# Evolution de la maladie en fonction de la duree de prise du traitement Tens (qu'il y ait eu arrêt ou non)
table_contingence_duree_evol_Tens <- table(Duree_T, data3$Evolution_Tens_NM[data3$Evolution_Tens_NM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_evol_Tens[c(4, 2, 3, 1, 5),], main = "Mosaïque Evolution x Duree Tens", cex.axis = 0.8, col = terrain.colors(length(unique(data3$Evolution_Tens_NM))),las = 4)
...
mosaicplot(table_contingence_tabac_douleur_TH[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Tabac TH", cex.axis = 1, col = terrain.colors(length(unique(data1$Douleur_TH))),las=4)
...
mosaicplot(table_contingence_tabac_douleur_CM[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Tabac CM", cex.axis = 1, col = terrain.colors(length(unique(data2$Douleur_CM))),las=4)


# Efficacite douleur Mobilite Tabac

table_contingence_tabac_douleur_Mobilite <- table(data$Tabac[which(data3$Mobilite_NM == 1)], dataM$Douleur_Mobilite_NM[dataM$Douleur_Mobilite_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Mobilite[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Tabac Mobilite", cex.axis = 1, col = terrain.colors(length(unique(dataM$Douleur_Mobilite_NM))),las=4)

# Efficacite douleur Nutrition Tabac
table_contingence_tabac_douleur_Nutrition <- table(data$Tabac[which(data$Nutrition_NM == 1)], dataN$Douleur_Nutrition_NM[dataN$Douleur_Nutrition_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Nutrition[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Tabac Nutrition", cex.axis = 1, col = terrain.colors(length(unique(dataN$Douleur_Nutrition_NM))),las=4)

# Efficacite douleur Stress Tabac
table_contingence_tabac_douleur_Stress <- table(data$Tabac[which(data$Stress_NM == 1)], dataS$Douleur_Stress_NM[dataS$Douleur_Stress_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Stress[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Tabac Stress", cex.axis = 1, col = terrain.colors(length(unique(dataS$Douleur_Stress_NM))),las=4)

# Efficacite douleur Phyto Tabac
table_contingence_tabac_douleur_Phyto <- table(data$Tabac[which(data$Phyto_NM == 1)], dataP$Douleur_Phyto_NM[dataP$Douleur_Phyto_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Phyto[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Tabac Phyto", cex.axis = 1, col = terrain.colors(length(unique(dataP$Douleur_Phyto_NM))),las=4)

# Efficacite douleur Acup Tabac
table_contingence_tabac_douleur_Acup <- table(data$Tabac[which(data$Acup_NM == 1)], dataA$Douleur_Acup_NM[dataA$Douleur_Acup_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Acup[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Tabac Acupuncture", cex.axis = 1, col = terrain.colors(length(unique(dataA$Douleur_Acup_NM))),las=4)

# Efficacite douleur Hypnose Tabac
table_contingence_tabac_douleur_Hypnose <- table(data$Tabac[which(data3$Hypnose_NM == 1)], dataH$Douleur_Hypnose_NM[dataH$Douleur_Hypnose_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Hypnose[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Tabac Hypnose", cex.axis = 1, col = terrain.colors(length(unique(dataH$Douleur_Hypnose_NM))),las=4)

# Efficacite douleur Bouillotte Tabac
table_contingence_tabac_douleur_Bouillotte <- table(data$Tabac[which(data3$Bouillotte_NM == 1)], dataB$Douleur_Bouillotte_NM[dataB$Douleur_Bouillotte_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Bouillotte[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Tabac Bouillotte", cex.axis = 1, col = terrain.colors(length(unique(dataB$Douleur_Bouillotte_NM))),las=4)

# Efficacite douleur CBD Tabac
table_contingence_tabac_douleur_CBD <- table(data$Tabac[which(data$CBD_NM == 1)], dataC$Douleur_CBD_NM[dataC$Douleur_CBD_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_CBD[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Tabac CBD", cex.axis = 1, col = terrain.colors(length(unique(dataC$Douleur_CBD_NM))),las=4)

# Efficacite douleur Tens Tabac
table_contingence_tabac_douleur_Tens <- table(data$Tabac[which(data$Tens_NM == 1)], dataT$Douleur_Tens_NM[dataT$Douleur_Tens_NM != "0"])

mosaicplot(table_contingence_tabac_douleur_Tens[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Tabac Tens", cex.axis = 1, col = terrain.colors(length(unique(dataT$Douleur_Tens_NM))),las=4)
...
mosaicplot(table_contingence_alcool_douleur_TH[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Alcool TH", cex.axis = 1, col = terrain.colors(length(unique(data1$Douleur_TH))),las=4)
...
mosaicplot(table_contingence_alcool_douleur_CM[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Alcool CM", cex.axis = 1, col = terrain.colors(length(unique(data2$Douleur_CM))),las=4)

# Efficacite douleur Mobilite Alcool

table_contingence_alcool_douleur_Mobilite <- table(data$Alcool[which(data3$Mobilite_NM == 1)], dataM$Douleur_Mobilite_NM[dataM$Douleur_Mobilite_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Mobilite[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Alcool Mobilite", cex.axis = 1, col = terrain.colors(length(unique(dataM$Douleur_Mobilite_NM))),las=4)

# Efficacite douleur Nutrition Alcool
table_contingence_alcool_douleur_Nutrition <- table(data$Alcool[which(data$Nutrition_NM == 1)], dataN$Douleur_Nutrition_NM[dataN$Douleur_Nutrition_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Nutrition[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Alcool Nutrition", cex.axis = 1, col = terrain.colors(length(unique(dataN$Douleur_Nutrition_NM))),las=4)


# Efficacite douleur Stress Alcool
table_contingence_alcool_douleur_Stress <- table(data$Alcool[which(data$Stress_NM == 1)], dataS$Douleur_Stress_NM[dataS$Douleur_Stress_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Stress[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Alcool Stress", cex.axis = 1, col = terrain.colors(length(unique(dataS$Douleur_Stress_NM))),las=4)


# Efficacite douleur Phyto Alcool
table_contingence_alcool_douleur_Phyto <- table(data$Alcool[which(data$Phyto_NM == 1)], dataP$Douleur_Phyto_NM[dataP$Douleur_Phyto_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Phyto[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Alcool Phyto", cex.axis = 1, col = terrain.colors(length(unique(dataP$Douleur_Phyto_NM))),las=4)


# Efficacite douleur Acup Alcool
table_contingence_alcool_douleur_Acup <- table(data$Alcool[which(data$Acup_NM == 1)], dataA$Douleur_Acup_NM[dataA$Douleur_Acup_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Acup[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Alcool Acup", cex.axis = 1, col = terrain.colors(length(unique(dataA$Douleur_Acup_NM))),las=4)


# Efficacite douleur Hypnose Alcool
table_contingence_alcool_douleur_Hypnose <- table(data$Alcool[which(data3$Hypnose_NM == 1)], dataH$Douleur_Hypnose_NM[dataH$Douleur_Hypnose_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Hypnose[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Alcool Hypnose", cex.axis = 1, col = terrain.colors(length(unique(dataH$Douleur_Hypnose_NM))),las=4)


# Efficacite douleur Bouillotte Alcool
table_contingence_alcool_douleur_Bouillotte <- table(data$Alcool[which(data3$Bouillotte_NM == 1)], dataB$Douleur_Bouillotte_NM[dataB$Douleur_Bouillotte_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Bouillotte[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Alcool Bouillotte", cex.axis = 1, col = terrain.colors(length(unique(dataB$Douleur_Bouillotte_NM))),las=4)


# Efficacite douleur CBD Alcool
table_contingence_alcool_douleur_CBD <- table(data$Alcool[which(data$CBD_NM == 1)], dataC$Douleur_CBD_NM[dataC$Douleur_CBD_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_CBD[,c(1, 3, 4, 2)], main = "Mosaïque Douleur x Alcool CBD", cex.axis = 1, col = terrain.colors(length(unique(dataC$Douleur_CBD_NM))),las=4)


# Efficacite douleur Tens Alcool
table_contingence_alcool_douleur_Tens <- table(data$Alcool[which(data$Tens_NM == 1)], dataT$Douleur_Tens_NM[dataT$Douleur_Tens_NM != "0"])

mosaicplot(table_contingence_alcool_douleur_Tens[,c(1, 4, 5, 3, 2)], main = "Mosaïque Douleur x Alcool Tens", cex.axis = 1, col = terrain.colors(length(unique(dataT$Douleur_Tens_NM))),las=4)
...
mosaicplot(table_contingence_prise_douleur_TH, main = "Mosaïque Douleur x Prise TH", cex.axis = 0.7, col = terrain.colors(length(unique(data1$Douleur_TH))),las=4)
...
mosaicplot(table_contingence_prise_douleur_CM, main = "Mosaïque Douleur x Prise CM", cex.axis = 0.7, col = terrain.colors(length(unique(data2$Douleur_CM))),las=4)


## Evolution de la douleur sous Mobilite en fonction de la prise

table_contingence_prise_douleur_Mobilite <- table(data3$Prise_Mobilite_NM[data3$Prise_Mobilite_NM != "0"], dataM$Douleur_Mobilite_NM[dataM$Douleur_Mobilite_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Mobilite, main = "Mosaïque Douleur x Prise Mobilite", cex.axis = 0.7, col = terrain.colors(length(unique(dataM$Douleur_Mobilite_NM))),las=4)

## Evolution de la douleur sous Nutrition en fonction de la prise

table_contingence_prise_douleur_Nutrition <- table(data3$Prise_Nutrition_NM[data3$Prise_Nutrition_NM != "0"], dataN$Douleur_Nutrition_NM[dataN$Douleur_Nutrition_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Nutrition, main = "Mosaïque Douleur x Prise Nutrition", cex.axis = 0.7, col = terrain.colors(length(unique(dataN$Douleur_Nutrition_NM))),las=4)

## Evolution de la douleur sous Stress en fonction de la prise

table_contingence_prise_douleur_Stress <- table(data3$Prise_Stress_NM[data3$Prise_Stress_NM != "0"], dataS$Douleur_Stress_NM[dataS$Douleur_Stress_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Stress, main = "Mosaïque Douleur x Prise Stress", cex.axis = 0.7, col = terrain.colors(length(unique(dataS$Douleur_Stress_NM))),las=4)

## Evolution de la douleur sous Phyto en fonction de la prise

table_contingence_prise_douleur_Phyto <- table(data3$Prise_Phyto_NM[data3$Prise_Phyto_NM != "0"], dataP$Douleur_Phyto_NM[dataP$Douleur_Phyto_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Phyto, main = "Mosaïque Douleur x Prise Phyto", cex.axis = 0.7, col = terrain.colors(length(unique(dataP$Douleur_Phyto_NM))),las=4)

## Evolution de la douleur sous Acup en fonction de la prise

table_contingence_prise_douleur_Acup <- table(data3$Prise_Acup_NM[data3$Prise_Acup_NM != "0"], dataA$Douleur_Acup_NM[dataA$Douleur_Acup_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Acup, main = "Mosaïque Douleur x Prise Acup", cex.axis = 0.7, col = terrain.colors(length(unique(dataA$Douleur_Acup_NM))),las=4)

## Evolution de la douleur sous Hypnose en fonction de la prise

table_contingence_prise_douleur_Hypnose <- table(data3$Prise_Hypnose_NM[data3$Prise_Hypnose_NM != "0"], dataH$Douleur_Hypnose_NM[dataH$Douleur_Hypnose_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Hypnose, main = "Mosaïque Douleur x Prise Hypnose", cex.axis = 0.7, col = terrain.colors(length(unique(dataH$Douleur_Hypnose_NM))),las=4)

## Evolution de la douleur sous Bouillotte en fonction de la prise

table_contingence_prise_douleur_Bouillotte <- table(data3$Prise_Bouillotte_NM[data3$Prise_Bouillotte_NM != "0"], dataB$Douleur_Bouillotte_NM[dataB$Douleur_Bouillotte_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Bouillotte, main = "Mosaïque Douleur x Prise Bouillotte", cex.axis = 0.7, col = terrain.colors(length(unique(dataB$Douleur_Bouillotte_NM))),las=4)

## Evolution de la douleur sous CBD en fonction de la prise

table_contingence_prise_douleur_CBD <- table(data3$Prise_CBD_NM[data3$Prise_CBD_NM != "0"], dataC$Douleur_CBD_NM[dataC$Douleur_CBD_NM != "0"])

mosaicplot(table_contingence_prise_douleur_CBD, main = "Mosaïque Douleur x Prise CBD", cex.axis = 0.7, col = terrain.colors(length(unique(dataC$Douleur_CBD_NM))),las=4)

## Evolution de la douleur sous Tens en fonction de la prise

table_contingence_prise_douleur_Tens <- table(data3$Prise_Tens_NM[data3$Prise_Tens_NM != "0"], dataT$Douleur_Tens_NM[dataT$Douleur_Tens_NM != "0"])

mosaicplot(table_contingence_prise_douleur_Tens, main = "Mosaïque Douleur x Prise Tens", cex.axis = 0.7, col = terrain.colors(length(unique(dataT$Douleur_Tens_NM))),las=4)
...
categories <- factor(c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"))
ordered_data1_table <- data1_table[order(categories)]
ordered_percentage_labels1 <- percentage_labels1[order(categories)]

pie(ordered_data1_table, main = "Échelles de douleur sous Traitement Hormonal", labels = ordered_percentage_labels1, col = colors_pastels_data1, cex.main = 0.75)
legend("bottom", legend = categories, fill = colors_pastels_data1, title = "Douleur_TH", cex = 0.75, xpd = TRUE, inset = c(0, -0.3))
...
ordered_data2_table <- data2_table[order(categories)]
ordered_percentage_labels2 <- percentage_labels2[order(categories)]

pie(ordered_data2_table, main = "Échelles de douleur sous Cure de Ménopause", labels = ordered_percentage_labels2, col = colors_pastels_data2, cex.main = 0.75)
legend("bottom", legend = categories, fill = colors_pastels_data2, title = "Douleur_CM", cex = 0.75, xpd = TRUE, inset = c(0, -0.3))

pie_table_CM <- table(data2$Douleur_CM)
text(0, 0, paste("Total:", sum(pie_table_CM)), cex = 0.8, pos = 2)
```

# Évolution TH / Évolution CM
## Pie charts
```{r}
options(repr.plot.width = 16, repr.plot.height = 10)
par(mfrow = c(1, 2))
...
categoriesE <- factor(c("Apparition de nouvelles lésions", "Grossissement des lésions déjà présentes", "Pas d'évolution", "Réduction modérée des lésions", "Réduction importante voire disparition des lésions", "Ne sais pas"))

ordered_data1_table <- data1_table[order(categoriesE)]
ordered_percentage_labels1 <- percentage_labels1[order(categoriesE)]

pie(ordered_data1_table, main = "Échelles d'évolution sous Traitement Hormonal", labels = ordered_percentage_labels1, col = colors_pastels_data1, cex.main = 0.75)
legend("bottom", legend = names(ordered_data1_table), fill = colors_pastels_data1, title = "Evolution_TH", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
ordered_data2_table <- data2_table[order(categoriesE)]
ordered_percentage_labels2 <- percentage_labels2[order(categoriesE)]

pie(ordered_data2_table, main = "Échelles d'évolution sous Cure de Ménopause", labels = ordered_percentage_labels2, col = colors_pastels_data2, cex.main = 0.75)
legend("bottom", legend = names(ordered_data2_table), fill = colors_pastels_data2, title = "Evolution_CM", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
legend("bottom", legend = categoriesD, fill = colors_pastels_data_MTH, title = "Douleur TH x Mobilite", cex = 0.9)
...
legend("bottom", legend = categoriesD, fill = colors_pastels_data_NTH, title = "Douleur TH x Nutrition", cex = 0.9)
