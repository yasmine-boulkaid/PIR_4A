...
Duree_S <- factor(ifelse(dataS$Depuis_Stress_NM == "0", as.character(dataS$Combien_Stress_NM), as.character(dataS$Depuis_Stress_NM)), levels = c("Moins de 3 mois", "Entre 3 et 6 mois", "Entre 6 mois et 2 ans", "Entre 2 et 5 ans", "Plus de 5 ans"), labels = c(".          - 3 mois", "3 mois /\n6 mois  ", "6 mois /\n2 ans  ", "2 ans /\n5 ans  ", ".          + 5 ans"), ordered = TRUE)
...
mosaicplot(table_contingence_duree_douleur_S, main = "Mosaïque Douleur x Stress NM", cex.axis = 0.8, col = terrain.colors(length(unique(data1$Douleur_TH))), las=4, xlab = "", ylab="")
```
...
Duree_A <- factor(ifelse(dataA$Depuis_Acup == "0", as.character(dataA$Combien_Acup_NM), as.character(dataA$Depuis_Acup_NM)), levels = c("Moins de 3 mois", "Entre 3 et 6 mois", "Entre 6 mois et 2 ans", "Entre 2 et 5 ans", "Plus de 5 ans"), labels = c(".          - 3 mois", "3 mois /\n6 mois  ", "6 mois /\n2 ans  ", "2 ans /\n5 ans  ", ".          + 5 ans"), ordered = TRUE)
...
table_contingence_duree_ES_TH <- table(Duree_TH_sans_label, data1$Subi_ES_TH[data1$Subi_ES_TH != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_ES_TH[c(4, 2, 3, 1, 5),], main = "Graphique de Mosaïque", cex.axis = 0.8, col = terrain.colors(length(unique(data1$Subi_ES_TH))),las = 4)


#Ont subi des effets secondaires en fonction duree traitement (CM)

table_contingence_duree_ES_CM <- table(Duree_CM_sans_label, data2$Subi_ES_CM[data2$Subi_ES_CM != "0"])

options(repr.plot.width = 12, repr.plot.height = 8)

mosaicplot(table_contingence_duree_ES_CM[c(4, 2, 3, 1, 5),], main = "Graphique de Mosaïque", cex.axis = 0.8, col = terrain.colors(length(unique(data2$Subi_ES_CM))),las = 4)
...
Ne pas faire le regroupement pour CBD
...
=> Âge indépendant de la perception de la douleur
