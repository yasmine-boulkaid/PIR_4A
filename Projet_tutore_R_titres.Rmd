...
data$Douleur_TH <- factor(Douleur_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), labels = c("Increase in pain", "No impact on pain", "Slight reduction in pain", "Significant reduction in pain"), ordered = TRUE)

Evolution_TH <- ifelse(data$Evolution_TH == "", "0", data$Evolution_TH)
data$Evolution_TH <- factor(Evolution_TH, levels = c("Apparition de nouvelles lésions", "Grossissement des lésions déjà présentes", "Pas d'évolution", "Réduction modérée des lésions", "Réduction importante voire disparition des lésions", "Ne sais pas"), labels = c("Appearance of new lesions", "Enlargement of existing lesions", "No progression", "Moderate reduction of lesions", "Significant reduction or disappearance of lesions", "Don't know"), ordered = TRUE)
...
data$Evolution_Nutrition_TH <- factor(Evolution_Nutrition_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Stress_TH <- factor(Evolution_Stress_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Douleur_Phyto_TH <- factor(Douleur_Phyto_TH, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction de la douleur"), labels = c("Increase in pain", "No impact on pain", "Decrease in pain"), ordered = FALSE)
...
data$Evolution_Phyto_TH <- factor(Evolution_Phyto_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Acup_TH <- factor(Evolution_Acup_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Hypnose_TH <- factor(Evolution_Hypnose_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Bouillotte_TH <- factor(Evolution_Bouillotte_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_CBD_TH <- factor(Evolution_CBD_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Tens_TH <- factor(Evolution_Tens_TH, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Douleur_CM <- factor(Douleur_CM, levels = c("Augmentation de la douleur", "Pas d'impact sur la douleur", "Réduction légère de la douleur", "Réduction importante de la douleur"), labels = c("Increase in pain", "No impact on pain", "Slight reduction in pain", "Significant reduction in pain"), ordered = TRUE)

Evolution_CM <- ifelse(data$Evolution_CM == "", "0", data$Evolution_CM)
data$Evolution_CM <- factor(Evolution_CM, levels = c("Apparition de nouvelles lésions", "Grossissement des lésions déjà présentes", "Pas d'évolution", "Réduction modérée des lésions", "Réduction importante voire disparition des lésions", "Ne sais pas"), labels = c("Appearance of new lesions", "Enlargement of existing lesions", "No progression", "Moderate reduction of lesions", "Significant reduction or disappearance of lesions", "Don't know"), ordered = TRUE)
...
data$Evolution_Mobilite_CM <- factor(Evolution_Mobilite_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Nutrition_CM <- factor(Evolution_Nutrition_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Stress_CM <- factor(Evolution_Stress_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Phyto_CM <- factor(Evolution_Phyto_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Acup_CM <- factor(Evolution_Acup_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Hypnose_CM <- factor(Evolution_Hypnose_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Bouillotte_CM <- factor(Evolution_Bouillotte_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_CBD_CM <- factor(Evolution_CBD_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
data$Evolution_Tens_CM <- factor(Evolution_Tens_CM, levels = c("Augmentation des lésions", "Pas d'impact sur les lésions", "Réduction des lésions", "Ne sais pas"), ordered = TRUE)
...
mosaicplot(table_contingence_duree_douleur_P, main = "Mosaïc Pain x Duration for Herbal medicine", cex.axis = 0.8, col = couleurs, las=4, xlab="")
...
pie(data1_table, main = "Pain Scale under Hormonal Treatment", labels = percentage_labels1, col = couleurs4, cex.main = 0.75)
...
pie(data2_table, main = "Pain Scale under Artificial Menopause", labels = percentage_labels2, col = couleurs4, cex.main = 0.75)
...
pie(data1_table, main = "Progression Scale under Hormonal Treatment", labels = percentage_labels1, col = couleurs5, cex.main = 0.75)
legend("bottom", legend = names(data1_table), fill = couleurs5, title = "Progression Scale", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
pie(data2_table, main = "Progression Scale under Artificial Menopause", labels = percentage_labels2, col = couleurs5, cex.main = 0.75)
legend("bottom", legend = names(data2_table), fill = couleurs5, title = "Progression Scale", cex = 0.7, xpd = TRUE, inset = c(0, -0.37))
...
names_variables <- c("Mobility", "Nutrition", "Stress", "Herbal \n Medicine", "Acup", "Hypnosis", "Hot Water \n Bottle", "CBD", "Tens")
...
for (i in seq_along(noms_variables)) {
  ...
  pourcentages[i] <- (sum(filtered_data[[variable]] == "Diminution de la douleur") + sum(filtered_data[[variable]] == "Decrease in pain")) / nrow(filtered_data) * 100
}
...
resultats1 <- data.frame(Variable = names_variables, Pourcentage = pourcentages, Total = total1)
...
bp <- barplot(resultats1$Pourcentage, names.arg = resultats1$Variable,
        ...
        main = "Percentage of 'Pain Reduction' by variable\nfor each non-drug treatment associated with Hormonal Treatment",
...
names_variables2 <- c("Mobility", "Nutrition", "Stress", "Herbal \n Medicine", "Acup", "Hot Water \n Bottle", "CBD", "Tens")
...
# Créer un dataframe pour stocker les résultats
resultats2 <- data.frame(Variable = names_variables2, Pourcentage = pourcentages2, Total = total2)
...
# Créer un dataframe pour stocker les résultats
resultats3 <- data.frame(Variable = names_variables, Pourcentage = pourcentages3, Total = total3)
...
bp <- barplot(resultats3$Pourcentage, names.arg = resultats3$Variable,
              xlab = "Variable", ylab = "Percentage of 'Pain Reduction'",
              main = "Percentage of 'Pain Reduction' by variable for each non-drug treatment alone",
