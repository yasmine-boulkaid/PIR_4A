...
fviz_mca_var(mca.combos.D, invisible=c("quali.sup"), repel=TRUE) + ggtitle("Graphe des var de tous les combos de traitements avec l'echelle de douleur en quali sup")
#col.var=Data_AMC_test$TM
...
# General
for (i in 29:38){
  print(fviz_mca_ind(mca.combos.D, habillage = i, repel = FALSE) + ggtitle(paste("Graphe des individus de tous les combos avec habillage \nen fonction de la douleur du combo TM avec "),names(Data_AMC_test[colonnes_combos_D[i]])) )
}
```
