...
mca.Score = MCA(Data_AMC_test[colonnes_Score], quali.sup = 1, quanti.sup = 11, graph=FALSE)
...
for (i in 1:nrow(Data_AMC_test)){
  for (duree in list("Duree_TM"," Duree_Mobilite", "Duree_Nutrition", "Duree_Stress", "Duree_Phyto", "Duree_Acup", "Duree_Hypnose", "Duree_Bouillotte", "Duree_CBD", "Duree_Tens")){
    if(!is.na(Data_AMC_test[i,duree])) {
      if(Data_AMC_test[i,duree] == "Plus de 5 ans" | Data_AMC_test[i,duree] == "Entre 2 et 5 ans" | Data_AMC_test[i,duree] == "Entre 6 mois et 2 ans"){
        Data_AMC_test[i,paste(duree, "_bis", sep="")] = "Plus de 6 mois"
      }
      if(Data_AMC_test[i,duree] == "Moins de 3 mois" | Data_AMC_test[i,duree] == "Entre 3 et 6 mois"){
