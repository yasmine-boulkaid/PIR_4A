...
```
On constate que les variables qui contribuent le plus sont celles qui sont le mieux représentées globalement 5 (Combos avec Mobilite, Bouillotte et Nutrition alors qu'au contraire combos avec Phyto et Acup contribuent le moins)
...
for (var in c("Duree_Mobilite","Duree_Nutrition","Duree_Stress","Duree_Phyto","Duree_Acup","Duree_Hypnose", "Duree_Bouillotte", "Duree_CBD", "Duree_Tens" )){
  titre <- paste("Graphe des individus des TNM avec habillage en fonction de la duree du TNM ")
  print(
